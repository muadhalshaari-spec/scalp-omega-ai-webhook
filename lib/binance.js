...
async function getPublicMarketData({ signal } = {}) {
  const publicEntries = [
    ...
    { label:'futures.takerBuySell', base:USD_M_BASE, path:'/futures/data/takerBuySellVol', params:{symbol:SYMBOL,period:'15m',limit:500} }
  ];
  ...
  for (const period of SENTIMENT_PERIODS) {
    publicEntries.push(
      ...
      { label:\`futures.takerBuySell.\${period}\`, base:USD_M_BASE, path:'/futures/data/takerBuySellVol', params:{symbol:SYMBOL,period,limit:500} },
