const TF_LIMITS = {
  '1m': { recent: 8, anchors: 1 },
  '5m': { recent: 8, anchors: 1 },
  '15m': { recent: 10, anchors: 1 },
  '1H': { recent: 8, anchors: 1 },
  '4H': { recent: 5, anchors: 1 },
  '1D': { recent: 3, anchors: 1 }
};
...
function compactMarket(market) {
  ...
  return {
    ...
    oiHistory: tail(market.oiHistory, 3),
    fundingHistory: tail(market.fundingHistory, 3),
    longShortHistory: tail(market.longShortHistory, 3),
    takerVolumeHistory: tail(market.takerVolumeHistory, 3),
    trades: tail(market.trades, 5),
    orderBook: trimBook(market.orderBook),
    liquidations: tail(market.liquidations, 5),
    liquidationHistory: tail(market.liquidationHistory, 5)
  };
}
