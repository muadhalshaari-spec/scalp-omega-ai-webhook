...
export function detectSetups({
  ...
  if (
    ...
    const quality = mean([
      0.8,
      momentum,
      structure?.structureEvent === 'BOS_BULLISH' ? 0.78 : 0.65,
  ...
  if (
    ...
    const quality = mean([
      0.8,
      momentumShort,
      structure?.structureEvent === 'BOS_BEARISH' ? 0.78 : 0.65,
