...
export function buildDataIntelligence(candlesByTf = {}, { mode = 'live' } = {}) {
  const audits = {};
  for (const [timeframe, candles] of Object.entries(candlesByTf)) {
    audits[timeframe] = auditTimeSeries(candles, timeframe);
  }

  const requiredMinimums = mode === 'backtest'
    ? { '15m': 220, '1H': 220, '4H': 120, '1D': 20 }
    : { '1m': 220, '5m': 220, '15m': 220, '1H': 220, '4H': 120, '1D': 20 };
