...
function safeModuleInput(base,canonical,outputs,index,moduleId){
  ...
  x.options=canonical.options||base.options||[]; x.iv=canonical.iv||base.iv||[]; x.skew=canonical.skew||base.skew||[]; x.putCall=canonical.putCall??base.putCall??x.putCall; x.strikes=canonical.strikes||base.strikes||[]; x.expiries=canonical.expiries||base.expiries||[];
...
export function runTitanPipeline(baseInput={}){
  ...
  if(m12.riskAllowed===false && titanBaseDecision!=="NO_TRADE")finalBlockers.push("RISK_GATE");
