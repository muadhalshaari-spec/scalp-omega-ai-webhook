...
function safeModuleInput(base,canonical,outputs,index,moduleId){
  ...
  if(moduleId==='TITAN-45'){
    ...
    x.evidence={decision:baseDecisionFromContext(base,canonical),price:pxSeed,regime:canonical.regime||base.regime||null,structure:canonical.structure||base.structure||null,liquidity:canonical.liquidity||base.liquidity||null,probability:canonical.probability||base.probability||null};
  ...
  if(moduleId==='TITAN-46'){
    x.decision={direction:baseDirectionFromContext(base,canonical),probability:canonical.probability??base.probability};
    x.risk=canonical.risk??base.risk??{allowed:false}; x.evidence={decision:baseDecisionFromContext(base,canonical),risk:x.risk,probability:canonical.probability||base.probability||null};
  }
