...
import { atr as kAtr, ema as kEma, rsi as kRsi, vwap as kVwap } from './kernel.js';
...
function safeModuleInput(base,canonical,outputs,index,moduleId){
  ...
  x.fundingTime=canonical.fundingTime??base.fundingTime??base.market?.fundingTime; x.nextFundingTime=canonical.nextFundingTime??base.nextFundingTime??base.market?.nextFundingTime??base.market?.nextFundingTime;
