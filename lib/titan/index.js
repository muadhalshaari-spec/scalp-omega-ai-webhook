...
function safeModuleInput(base,canonical,outputs,index,moduleId,moduleTestStatus={}){
  ...
  if(moduleId==='TITAN-45'){
    ...
    x.aiOutput={status:'NOT_RUN',verdict:'NO_AI_VERDICT',confidence:0,reason:'GPT audit is optional and downstream of deterministic decision'}; x.policy={noOverride:true,noInvention:true};
  }
