...
import { getMicrostructureHistory } from '../lib/supabase.js';
...
export default async function handler(req,res){
  ...
  try{
    ...
    const [memory, microHistory] = await Promise.all([
